...
execute if score @s fav3 matches 1.. run tellraw @s ["",{"text":"Now tracking: ","color":"green"},{"text":"#","color":"yellow"},{"score":{"name":"@s","objective":"fav3"},"color":"yellow"}]
execute if score @s fav3 matches 0 run tellraw @s ["",{"text":"Error: ","bold":true,"color":"dark_red"},{"text":"This favorite slot is empty.","color":"red"}]
