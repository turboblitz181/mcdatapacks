...
# Title
tellraw @s ["\n",{"text":"=== Pokémon Tracker (Page 1) ===","bold":true,"color":"aqua"}]
...
tellraw @s ["\n",{"text":"[Next Page]","color":"gold","clickEvent":{"action":"run_command","value":"/trigger pokemenu set 102"}},{"text":" | ","color":"gray"},{"text":"[Back to Main Menu]","color":"green","clickEvent":{"action":"run_command","value":"/trigger pokemenu set 1"}}]