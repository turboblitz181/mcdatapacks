...
execute if score @s sp_particle matches 1 run tellraw @s ["",{"text":"[✨] ","color":"green","bold":true},{"text":"Particles: ","color":"white"},{"text":"ON","color":"green"},{"text":" [Disable]","color":"red","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -1"}}]
execute if score @s sp_particle matches 0 run tellraw @s ["",{"text":"[✨] ","color":"gray"},{"text":"Particles: ","color":"gray"},{"text":"OFF","color":"red"},{"text":" [Enable]","color":"green","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -2"}}]

# shiny sound toggle
execute if score @s sp_sound matches 1 run tellraw @s ["",{"text":"[🔊] ","color":"green","bold":true},{"text":"Sound: ","color":"white"},{"text":"ON","color":"green"},{"text":" [Disable]","color":"red","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -3"}}]
...
execute if score @s sp_color matches 4 run tellraw @s ["",{"text":"[🟢] ","color":"yellow","bold":true},{"text":"Particle Color: ","color":"white"},{"text":"Yellow","color":"yellow"},{"text":" [Click to cycle]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -5"}}]
execute if score @s sp_color matches 5 run tellraw @s ["",{"text":"[🟢] ","color":"green","bold":true},{"text":"Particle Color: ","color":"white"},{"text":"Green","color":"green"},{"text":" [Click to cycle]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -5"}}]
execute if score @s sp_color matches 6 run tellraw @s ["",{"text":"[🟢] ","color":"aqua","bold":true},{"text":"Particle Color: ","color":"white"},{"text":"Aqua","color":"aqua"},{"text":" [Click to cycle]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -5"}}]
execute if score @s sp_color matches 7 run tellraw @s ["",{"text":"[🟢] ","color":"blue","bold":true},{"text":"Particle Color: ","color":"white"},{"text":"Blue","color":"blue"},{"text":" [Click to cycle]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger sp_menu set -5"}}]
