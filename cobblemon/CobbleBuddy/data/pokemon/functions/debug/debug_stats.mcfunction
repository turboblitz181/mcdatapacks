##
# debug_stats.mcfunction - Verbeterd met kleurcodering
##
...
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run tellraw @p ["",{"text":"Testing Pokémon: ","color":"gold"},{"selector":"@s","color":"white"}]

# Get Pokédex ID test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_dex_id
tellraw @s ["",{"text":"Pokédex ID: ","color":"gold"},{"score":{"name":"#dex_id","objective":"pokemon.temp"},"color":"aqua"}]

# Get display name test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/core/get_display_name
tellraw @s ["",{"text":"Display Name: ","color":"gold"},{"nbt":"DisplayName","storage":"pokemon:temp","color":"aqua"}]

# Get species test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/core/get_species
tellraw @s ["",{"text":"Species: ","color":"gold"},{"nbt":"species","storage":"pokemon:temp","color":"aqua"}]

# Get clean species test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/core/get_clean_species
tellraw @s ["",{"text":"Clean Species: ","color":"gold"},{"nbt":"clean_species","storage":"pokemon:temp","color":"aqua"}]

# Get level test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_level
tellraw @s ["",{"text":"Level: ","color":"gold"},{"score":{"name":"#level","objective":"pokemon.temp"},"color":"aqua"}]

# Get nature test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_nature
tellraw @s ["",{"text":"Nature: ","color":"gold"},{"nbt":"nature","storage":"pokemon:temp","color":"aqua"}]

# Get gender test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_gender
tellraw @s ["",{"text":"Gender: ","color":"gold"},{"nbt":"gender","storage":"pokemon:temp","color":"aqua"}]

# Get form test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/core/get_form
tellraw @s ["",{"text":"Form: ","color":"gold"},{"nbt":"form","storage":"pokemon:temp","color":"aqua"}]

# Get types test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_types
tellraw @s ["",{"text":"Types: ","color":"gold"},{"nbt":"types","storage":"pokemon:temp","color":"aqua"}]

# Toon Base Stats direct uit storage
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_stats
...
# Get IVs test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/stats/get_ivs
...
# Check wild test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/checks/check_wild
...
# Check shiny test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/checks/check_shiny
...
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:utils/checks/check_legendary
