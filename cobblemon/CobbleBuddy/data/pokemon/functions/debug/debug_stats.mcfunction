...
# Get Pokédex ID test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:stats/get_dex_id
tellraw @s ["",{"text":"Pokédex ID: ","color":"gold"},{"score":{"name":"#dex_id","objective":"pokemon.temp"},"color":"aqua"}]

# Get display name test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:core/get_display_name
tellraw @s ["",{"text":"Display Name: ","color":"gold"},{"nbt":"displayname","storage":"pokemon:temp","color":"aqua"}]

# Get species test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:core/get_species
tellraw @s ["",{"text":"Species: ","color":"gold"},{"nbt":"species","storage":"pokemon:temp","color":"aqua"}]

# Get level test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:stats/get_level
tellraw @s ["",{"text":"Level: ","color":"gold"},{"score":{"name":"#level","objective":"pokemon.temp"},"color":"aqua"}]

# Get nature test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:stats/get_nature
tellraw @s ["",{"text":"Nature: ","color":"gold"},{"nbt":"nature","storage":"pokemon:temp","color":"aqua"}]

# Get gender test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:stats/get_gender
tellraw @s ["",{"text":"Gender: ","color":"gold"},{"nbt":"gender","storage":"pokemon:temp","color":"aqua"}]

# Get form test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:core/get_form
tellraw @s ["",{"text":"Form: ","color":"gold"},{"nbt":"form","storage":"pokemon:temp","color":"aqua"}]

# Get types test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:stats/get_types
...
# Check wild test
execute as @e[type=cobblemon:pokemon,sort=nearest,limit=1] run function pokemon:checks/check_wild
