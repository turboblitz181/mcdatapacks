...
tellraw @s ["",{"text":"[Entity Management]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger admin set 2"}}]
...
tellraw @s ["",{"text":"[Toggle Modules]","color":"green","clickEvent":{"action":"run_command","value":"/trigger admin set 5"}}]
