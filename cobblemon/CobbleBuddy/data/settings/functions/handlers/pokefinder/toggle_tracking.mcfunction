...
# Give feedback
execute if score @s pf.tracking_enabled matches 0 run tellraw @s ["",{"text":"PokeFinder: ","color":"aqua"},{"text":"Tracking is now ","color":"yellow"},{"text":"OFF","color":"red","bold":true}]
execute if score @s pf.tracking_enabled matches 1 run tellraw @s ["",{"text":"PokeFinder: ","color":"aqua"},{"text":"Tracking is now ","color":"yellow"},{"text":"ON","color":"green","bold":true}]
