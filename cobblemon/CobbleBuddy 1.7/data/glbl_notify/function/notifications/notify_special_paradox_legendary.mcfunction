...
# Actionbar
$title @a[scores={gn_actionbar=1}] actionbar [{"text":"✨","color":"gold","bold":true},{"text":"♦ ","color":"dark_green","bold":true},{"text":"$(species)","color":"red","bold":true},{"text":" at $(x), $(y), $(z)!","color":"green"}]
