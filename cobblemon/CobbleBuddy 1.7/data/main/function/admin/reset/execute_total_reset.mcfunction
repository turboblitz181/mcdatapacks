...
# The true nuclear option - removes EVERYTHING except players and critical entities
kill @e[type=!player,type=!minecraft:armor_stand,type=!minecraft:item_frame,type=!minecraft:glow_item_frame,type=!minecraft:painting,type=!cobblemon:pokemon]
