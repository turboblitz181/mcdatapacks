...
execute if score badges enabled matches 1 run tellraw @s ["",{"text":"Badges: ","color":"blue"},{"text":"✓ Enabled","color":"green"}]
execute unless score badges enabled matches 1 run tellraw @s ["",{"text":"Badges: ","color":"blue"},{"text":"✗ Disabled","color":"red"}]
