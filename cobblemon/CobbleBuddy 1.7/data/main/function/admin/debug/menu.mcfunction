...
tellraw @s ["",{"text":"• [Check ID admins]","color":"dark_aqua","clickEvent":{"action":"run_command","value":"/trigger admin set 93"},"hoverEvent":{"action":"show_text","contents":"View ID of all admins"}}]
