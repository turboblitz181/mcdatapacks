...
tellraw @s ["",{"text":"[Gym Leader Overview]","color":"aqua","clickEvent":{"action":"run_command","value":"/trigger admin set 69"},"hoverEvent":{"action":"show_text","contents":"View a list of all current Gym Leaders"}}]
...
tellraw @s ["",{"text":"[Remove a Badge]","color":"red","clickEvent":{"action":"run_command","value":"/trigger admin set 70"},"hoverEvent":{"action":"show_text","contents":"Directly remove any badge to any player"}}]
