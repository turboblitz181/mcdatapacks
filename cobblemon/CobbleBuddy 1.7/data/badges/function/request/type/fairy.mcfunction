...
execute if score @s badge_fairy matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Fairy Badge!","color":"yellow"}]
execute if score @s badge_fairy matches 1 run return 0
