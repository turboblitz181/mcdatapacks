...
execute if score @s badge_dark matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Dark Badge!","color":"yellow"}]
execute if score @s badge_dark matches 1 run return 0
