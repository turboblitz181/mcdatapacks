...
execute if score @s hardcore_mode matches 0 if score @s badge_bug matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Bug Badge!","color":"yellow"}]
execute if score @s hardcore_mode matches 0 if score @s badge_bug matches 1 run return 0
execute if score @s hardcore_mode matches 1 if score @s badge_hc_bug matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Hardcore Bug Badge!","color":"yellow"}]
execute if score @s hardcore_mode matches 1 if score @s badge_hc_bug matches 1 run return 0
