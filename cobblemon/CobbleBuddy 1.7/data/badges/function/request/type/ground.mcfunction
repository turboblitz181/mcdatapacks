...
execute if score @s badge_ground matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Ground Badge!","color":"yellow"}]
execute if score @s badge_ground matches 1 run return 0
