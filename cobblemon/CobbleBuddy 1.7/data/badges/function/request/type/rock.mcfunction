...
execute if score @s hardcore_mode matches 0 if score @s badge_rock matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Rock Badge!","color":"yellow"}]
execute if score @s hardcore_mode matches 0 if score @s badge_rock matches 1 run return 0
execute if score @s hardcore_mode matches 1 if score @s badge_hc_rock matches 1 run tellraw @s ["",{"text":"[Badges] ","color":"gold","bold":true},{"text":"You already have the Hardcore Rock Badge!","color":"yellow"}]
execute if score @s hardcore_mode matches 1 if score @s badge_hc_rock matches 1 run return 0
