# Casual menu
tellraw @s ["",{"text":"--- Casual ---","color":"green","bold":true}]
...
tellraw @s ["",{"text":"Casual collected: ","color":"white"},{"score":{"name":"@s","objective":"badge_count"},"color":"gold","bold":true},{"text":"/18","color":"white"}]
