...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Raikou]","color":"yellow","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Electric","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 243"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Entei]","color":"red","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Fire","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 244"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Suicune]","color":"blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Water","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 245"}}]
...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Lugia]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Psychic/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 249"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Ho-oh]","color":"red","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Fire/Flying","color":"red"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 250"}}]
