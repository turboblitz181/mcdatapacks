...
# Title
tellraw @s ["\n",{"text":"=== Pokémon Tracker (Page 64) ===","bold":true,"color":"aqua"}]
...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Cobalion]","color":"gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Steel/Fighting","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 638"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Terrakion]","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Rock/Fighting","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 639"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Virizion]","color":"green","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Grass/Fighting","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 640"}}]
