...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Xerneas]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 716"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Yveltal]","color":"dark_gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Dark/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 717"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Zygarde]","color":"dark_blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Dragon/Ground","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 718"}}]
tellraw @s ["",{"text":"👑 ","color":"light_purple","bold":true},{"text":"[Diancie]","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Rock/Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 719"}}]
tellraw @s ["",{"text":"👑 ","color":"light_purple","bold":true},{"text":"[Hoopa]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Psychic/Ghost","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 720"}}]
