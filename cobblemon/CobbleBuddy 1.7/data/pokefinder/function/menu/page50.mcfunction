...
# Pokémon List
tellraw @s ["",{"text":"👑 ","color":"dark_purple","bold":true},{"text":"[Darkrai]","color":"dark_gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Dark","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 491"}}]
tellraw @s ["",{"text":"👑 ","color":"dark_purple","bold":true},{"text":"[Shaymin]","color":"green","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Grass","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 492"}}]
tellraw @s ["",{"text":"👑 ","color":"dark_purple","bold":true},{"text":"[Arceus]","color":"gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Normal","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 493"}}]
tellraw @s ["",{"text":"👑 ","color":"dark_purple","bold":true},{"text":"[Victini]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Psychic/Fire","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 494"}}]
