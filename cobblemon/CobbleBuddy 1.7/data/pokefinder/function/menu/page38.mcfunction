...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Regirock]","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Rock","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 377"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Regice]","color":"aqua","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Ice","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 378"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Registeel]","color":"gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Steel","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 379"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Latias]","color":"dark_blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Dragon/Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 380"}}]
