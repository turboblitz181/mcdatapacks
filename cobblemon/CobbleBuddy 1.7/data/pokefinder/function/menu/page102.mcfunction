...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Okidogi]","color":"dark_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Poison/Fighting","color":"dark_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1014"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Munkidori]","color":"dark_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Poison/Psychic","color":"dark_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1015"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Fezandipiti]","color":"dark_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Poison/Fairy","color":"dark_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1016"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Ogerpon]","color":"green","hoverEvent":{"action":"show_text","contents":["",{"text":"Type: Grass","color":"green"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1017"}}]
...
tellraw @s ["",{"text":"♦ ","color":"dark_green","bold":true},{"text":"[Gouging Fire]","color":"red","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Fire/Dragon","color":"red"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1020"}}]
