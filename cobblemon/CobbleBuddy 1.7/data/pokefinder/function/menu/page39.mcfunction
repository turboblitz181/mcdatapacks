...
# Pokémon List
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Latios]","color":"dark_blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Dragon/Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 381"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Kyogre]","color":"blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Water","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 382"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Groudon]","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Ground","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 383"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Rayquaza]","color":"dark_blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Dragon/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 384"}}]
tellraw @s ["",{"text":"👑 ","color":"light_purple","bold":true},{"text":"[Jirachi]","color":"gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Steel/Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 385"}}]
tellraw @s ["",{"text":"👑 ","color":"light_purple","bold":true},{"text":"[Deoxys]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 386"}}]
