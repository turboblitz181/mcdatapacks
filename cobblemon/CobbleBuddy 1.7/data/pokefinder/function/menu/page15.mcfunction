...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Articuno]","color":"aqua","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Ice/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 144"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Zapdos]","color":"yellow","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Electric/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 145"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Moltres]","color":"red","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Fire/Flying","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 146"}}]
...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Mewtwo]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 150"}}]
