...
# Pokémon List
tellraw @s ["",{"text":"♦ ","color":"dark_green","bold":true},{"text":"[Raging Bolt]","color":"yellow","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Electric/Dragon","color":"yellow"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1021"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_green","bold":true},{"text":"[Iron Boulder]","color":"gold","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Rock/Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1022"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_green","bold":true},{"text":"[Iron Crown]","color":"gray","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Steel/Psychic","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 1023"}}]
