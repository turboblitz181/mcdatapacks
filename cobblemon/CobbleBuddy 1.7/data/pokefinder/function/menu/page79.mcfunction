...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Tapu Koko]","color":"yellow","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Electric/Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 785"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Tapu Lele]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Psychic/Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 786"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Tapu Bulu]","color":"green","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Grass/Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 787"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Tapu Fini]","color":"blue","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nTypes: Water/Fairy","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 788"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Cosmog]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 789"}}]
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Cosmoem]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Legendary Pokémon\nType: Psychic","color":"gold"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 790"}}]
