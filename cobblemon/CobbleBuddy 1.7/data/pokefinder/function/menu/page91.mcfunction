...
tellraw @s ["",{"text":"♦ ","color":"dark_purple","bold":true},{"text":"[Enamorus]","color":"light_purple","hoverEvent":{"action":"show_text","contents":["",{"text":"Types: Fairy/Flying","color":"light_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger poketrack set 905"}}]
