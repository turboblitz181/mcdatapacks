...
execute as @a unless score @s sp_sync matches 0..1 run scoreboard players set @s sp_sync 1
...
execute if score timer sp_timer matches 5 as @a[scores={sp_particle=1,sp_sync=1}] at @s run function shiny_particles:particles/pokeball
