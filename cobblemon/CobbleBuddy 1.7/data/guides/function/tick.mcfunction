...
execute as @a[scores={guides=-2}] run function guides:menu/pokefinder
execute as @a[scores={guides=-3}] run function guides:menu/glbl_notify
execute as @a[scores={guides=-4}] run function guides:menu/egg_data
execute as @a[scores={guides=-5}] run function guides:menu/shiny_particles
execute as @a[scores={guides=-6}] run function guides:menu/badges
