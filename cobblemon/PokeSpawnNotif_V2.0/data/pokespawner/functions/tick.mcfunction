...
execute as @a[scores={toggle_notifs=1..}] run function pokespawner:tracking/toggle_notification
...
execute as @a[scores={pokespawnnotif=1..}] run function pokespawner:handle/handle_normal_trigger
...
execute as @a[scores={pokemenu=..-1}] run function pokespawner:handle/handle_menu
execute as @a[scores={pokemenu=1..}] run function pokespawner:handle/handle_menu
