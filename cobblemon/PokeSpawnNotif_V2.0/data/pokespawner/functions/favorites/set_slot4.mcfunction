...
scoreboard players operation @s fav4 = @s tracking
...
tellraw @s ["",{"text":"✓ ","bold":true,"color":"green"},{"text":"Favorite Slot 4 set to: ","color":"gold"},{"nbt":"CurrentPokemon","storage":"pokespawner:temp","color":"yellow"}]
