...
execute if entity @s[scores={pokemenu=11..15}] if score @s tracking matches 1.. run function pokespawner:menu/get_pokemon_name
...
execute if entity @s[scores={pokemenu=51..55}] if score @s tracking matches 1.. run function pokespawner:menu/get_pokemon_name
