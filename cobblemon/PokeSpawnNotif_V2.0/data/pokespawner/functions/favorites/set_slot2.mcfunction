...
scoreboard players operation @s fav2 = @s tracking
...
tellraw @s ["",{"text":"✓ ","bold":true,"color":"green"},{"text":"Favorite Slot 2 set to: ","color":"gold"},{"nbt":"CurrentPokemon","storage":"pokespawner:temp","color":"yellow"}]
