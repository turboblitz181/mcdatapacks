...
execute if score @s fav1 matches 1.. run function pokespawner:favorites/get_name_by_id
...
execute if score @s fav2 matches 1.. run function pokespawner:favorites/get_name_by_id
...
execute if score @s fav3 matches 1.. run function pokespawner:favorites/get_name_by_id
...
execute if score @s fav4 matches 1.. run function pokespawner:favorites/get_name_by_id
...
execute if score @s fav5 matches 1.. run function pokespawner:favorites/get_name_by_id
