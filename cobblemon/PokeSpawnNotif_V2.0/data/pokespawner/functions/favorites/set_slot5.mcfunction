...
scoreboard players operation @s fav5 = @s tracking
...
tellraw @s ["",{"text":"✓ ","bold":true,"color":"green"},{"text":"Favorite Slot 5 set to: ","color":"gold"},{"nbt":"CurrentPokemon","storage":"pokespawner:temp","color":"yellow"}]
...
# Refresh display
execute as @s run function pokespawner:favorites/refresh_display