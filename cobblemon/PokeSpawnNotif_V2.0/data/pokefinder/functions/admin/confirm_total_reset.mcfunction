...
tellraw @s ["",{"text":"[YES, REMOVE EVERYTHING]","color":"dark_red","bold":true,"clickEvent":{"action":"run_command","value":"/function pokefinder:admin/execute_total_reset"},"hoverEvent":{"action":"show_text","contents":"This will remove ALL non-player entities"}}]
