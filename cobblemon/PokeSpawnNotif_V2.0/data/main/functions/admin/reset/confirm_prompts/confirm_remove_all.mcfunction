...
tellraw @s ["",{"text":"[YES, REMOVE ALL]","color":"dark_red","bold":true,"clickEvent":{"action":"run_command","value":"/function main:admin/reset/confirm_prompts/execute_remove_all"},"hoverEvent":{"action":"show_text","contents":"This will remove most entities"}}]
