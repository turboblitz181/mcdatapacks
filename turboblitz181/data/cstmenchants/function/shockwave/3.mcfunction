...
execute at @s as @e[type=!minecraft:player,distance=..5] run data modify entity @s Motion[1] set value 0.6d
execute at @s as @e[type=!minecraft:player,distance=..5] store result entity @s Motion[0] float 0.6 run scoreboard players get @s tur_distance_x
execute at @s as @e[type=!minecraft:player,distance=..5] store result entity @s Motion[2] float 0.6 run scoreboard players get @s tur_distance_z