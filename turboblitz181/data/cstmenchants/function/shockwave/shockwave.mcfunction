...
execute at @s as @e[type=!minecraft:player,distance=..3] run data modify entity @s Motion[1] set value 1d
execute at @s as @e[type=!minecraft:player,distance=..3] facing entity @p eyes store result entity @s Motion[0] float 0.5 run scoreboard players get @s tur_distance_x
execute at @s as @e[type=!minecraft:player,distance=..3] facing entity @p eyes store result entity @s Motion[2] float 0.5 run scoreboard players get @s tur_distance_z